/**
 * Globe
 * Interactive autorotating WebGL globe using cobe + motion/react springs.
 * Drag to rotate. Renders city markers. Fully responsive.
 *
 * Deps: cobe, motion/react
 * Usage:
 *   <div className="relative h-96">
 *     <Globe />
 *   </div>
 *
 *   // Custom config and markers
 *   <Globe
 *     config={{
 *       ...GLOBE_CONFIG,
 *       dark: 1,
