...
export interface LandingProductProcurementTimelineProps extends React.HTMLAttributes<HTMLElement> {
  title?: string;
  description?: string;
  items: ProcurementTimelineItem[];
}

export const LandingProductProcurementTimeline = React.forwardRef<HTMLElement, LandingProductProcurementTimelineProps>(
  ({ className, title = "Show the procurement timeline before stakeholders guess", description, items, ...props }, ref) => {
    return (
...
LandingProductProcurementTimeline.displayName = "LandingProductProcurementTimeline";