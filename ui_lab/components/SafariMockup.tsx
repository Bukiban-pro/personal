/**
 * Safari
 * Safari browser window mockup SVG for showcasing websites/screenshots/videos.
 * Two modes: "default" (full toolbar with nav icons) and "simple" (minimal toolbar).
 * Displays image OR video inside the screen area.
 *
 * Deps: none
 * Usage:
 *   // Static screenshot
 *   <Safari url="acme.com" imageSrc="/screenshot.png" className="w-full" />
 *
 *   // Video demo
 *   <Safari url="app.acme.com" videoSrc="/demo.mp4" />
 *
 *   // Empty browser (slot for embedding)
 *   <Safari url="acme.com" mode="simple" />
 */
