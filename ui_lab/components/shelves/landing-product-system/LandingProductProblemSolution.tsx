...
import { LandingProductFeatureKeyPoints, KeyPoint } from "./LandingProductFeatureKeyPoints";
 ...
 *
 * Renders two columns (or stacked on mobile) showing problems and solutions side-by-side.
 * Pass `problems` and `solutions` as `KeyPoint[]` (title + optional description).
 * Uses red background for problems (X icon), green for solutions (check icon).
 */
export const LandingProductProblemSolution = ({
  className,
  title,
  titleComponent,
  description,
  ...
  >
    ...
    <div
      className={cn(
        "container-wide w-full px-6 flex flex-col relative max-w-6xl mx-auto",
        textPosition === "left"
