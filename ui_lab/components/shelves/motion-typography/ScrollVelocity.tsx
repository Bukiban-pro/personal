/**
 * ScrollVelocity
 * Infinite marquee whose scroll speed reacts to page scroll velocity.
 * Scrolling fast → text speeds up. Stopping → returns to base speed.
 * Supports multiple rows with shared velocity context.
 *
 * Deps: motion/react
 * Usage:
 *   // Single row
 ...
 *   </ScrollVelocityRow>
 *
 *   // Shared velocity (both rows react to same scroll)
 *   <ScrollVelocityContainer>
 *     <ScrollVelocityRow baseVelocity={4}>Row one content</ScrollVelocityRow>
 *     <ScrollVelocityRow baseVelocity={4} direction={-1}>Row two content</ScrollVelocityRow>
 *   </ScrollVelocityContainer>
 */
"use client"
