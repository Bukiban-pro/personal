/**
 * ComicText
 * Bold, skewed, dot-halftone comic book text with thick outline and drop shadow.
 * Framer Motion entrance animation included.
 *
 * Deps: motion/react
 * Usage:
 *   <ComicText>POW!</ComicText>
 *   <ComicText fontSize={8} className="text-center">BOOM!</ComicText>
 */
"use client"
