 ...
 * Numbers roll/tick up (or down) with smooth easing.
 * The statistics counter effect from every premium landing page.
 *
 * @example
 * <NumberTicker value={10583} prefix="$" />
 * <NumberTicker value={99.9} suffix="%" decimals={1} />
 * <NumberTicker value={50000} suffix="+" locale="en-US" />
 */
