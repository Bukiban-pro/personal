/**
 * SmoothCursor
 * Physics-based custom cursor with spring animation, velocity-based tilt rotation,
 * and scale-on-move. Only enables on desktop (any-hover: hover) + fine pointer.
 * Hides native cursor, replaces with SVG arrow (or custom children).
 *
 * Deps: motion/react
 * Usage:
 *   // In app layout — renders globally
 *   <SmoothCursor />
 *
 *   // Custom cursor SVG/element
 *   <SmoothCursor cursor={<MyCustomCursorIcon />} />
 *
 *   // Tuned spring
 *   <SmoothCursor springConfig={{ damping: 25, stiffness: 250, mass: 0.8, restDelta: 0.001 }} />
 */
"use client"
