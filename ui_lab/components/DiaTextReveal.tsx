...
export interface DiaTextRevealProps extends
  Omit<
  ...
  colors?: string[]
  /** CSS color for revealed text after the sweep. @default `"var(--foreground)"` */
  textColor?: string
  /** Duration of one sweep pass, in seconds. @default `1.5` */
  duration?: number
  /** Delay before the sweep starts, in seconds. @default `0` */
  delay?: number
  /** When `text` is an array, replay the sweep and advance to the next string. @default `false` */
  repeat?: boolean
  /** Pause between cycles when `repeat` is `true`, in seconds. @default `0.5` */
  repeatDelay?: number
  /** If `true`, the animation starts only after the element enters the viewport. @default `true` */
  startOnView?: boolean
  /** If `true`, in-view detection fires at most once. @default `true` */
  once?: boolean
  className?: string
  /** When `text` has multiple entries, use the widest string's width for layout. @default `false` */
  fixedWidth?: boolean
}
