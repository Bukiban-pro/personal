/**
 * Terminal
 * Animated macOS-style terminal window with sequenced typing and fade-in lines.
 * Components: Terminal (container), TypingAnimation (per-line typewriter), AnimatedSpan (instant fade-in).
 *
 * Deps: motion/react
 * Usage:
 *   <Terminal>
 *     <TypingAnimation>$ npm install</TypingAnimation>
 *     <AnimatedSpan className="text-green-500">✓ Packages installed</AnimatedSpan>
 *     <TypingAnimation>$ npm run dev</TypingAnimation>
 *     <AnimatedSpan>  → http://localhost:3000</AnimatedSpan>
 *   </Terminal>
 *
 *   // No sequence (all animate independently)
 *   <Terminal sequence={false}>
 *     <TypingAnimation startOnView>$ echo "Hello World"</TypingAnimation>
 *   </Terminal>
 */
"use client"
