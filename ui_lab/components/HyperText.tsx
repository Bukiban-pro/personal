/**
 * HyperText
 * Letter scramble animation that decodes from random characters to the final text.
 * More advanced than TextScramble — supports view-trigger, hover-trigger,
 * custom character sets, and polymorphic `as` prop.
 *
 * Deps: motion/react
 * Usage:
 *   <HyperText>Hello World</HyperText>
 *   <HyperText startOnView duration={600} as="h1" className="text-4xl font-bold">
 *     Loading Complete
 *   </HyperText>
 *   <HyperText animateOnHover characterSet={["0","1"]}>Binary mode</HyperText>
 */
"use client"
