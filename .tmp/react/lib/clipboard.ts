 ...
 *
 * Stolen from: ChefKix CelebrationProvider (shareWithFallback), duplicated
 * navigator.clipboard patterns across all 3 codebases.
 *
 * Dependencies: None
 *
 * @example
 ...
 */
export async function shareContent(content: ShareContent): Promise<'shared' | 'copied' | 'failed'> {
