 ...
 *
 * Stolen from: Composite across Chefkix (sidebar widths, header heights), Bookverse (z-index),
 * and 5TProMart (sidebar collapse widths, breakpoint usage).
 *
 ...
 * className={`w-[${SIDEBAR.expandedWidth}px]`}
 */
