...
/**
 * Toaster — Global toast manager with imperative API.
 *
 * Dependencies: Toast, Portal, cn()
 *
 ...
 *   toast.promise(mutation, { loading: '...', success: 'Done', error: 'Failed' })
 */
...
export const toast = {
	...
	/** Loading → success/error based on promise result */
	promise: async <T,>(
		promise: Promise<T>,
		messages: {
			loading: string
