/**
 * ShinyButton
 * A button with a light shimmer sweep across text that infinitely loops.
 * Light mode: black text with mask-based shine. Dark mode: white text with subtle glow.
 * Uses a motion CSS variable `--x` for the shimmer position.
 *
 * Deps: motion/react
 * Usage:
 *   <ShinyButton>Get Started</ShinyButton>
 *   <ShinyButton className="bg-primary text-primary-foreground">Subscribe</ShinyButton>
