/**
 * IconCloud
 * Interactive 3D rotating sphere of icons/images with mouse-drag and click-to-focus.
 * Uses HTML Canvas + requestAnimationFrame — no WebGL, no Three.js.
 *
 * Deps: react-dom/server (renderToString for SVG icons)
 * Usage:
 *   // With SVG React icons (from lucide-react, react-icons, etc.)
 *   import { ReactIcon, NextjsIcon, TailwindIcon } from "..."
 *   <IconCloud icons={[<ReactIcon />, <NextjsIcon />, <TailwindIcon />]} />
 *
 *   // With image URLs
 *   <IconCloud images={[
...
export function IconCloud({ icons, images }: IconCloudProps) {
  ...
  const [targetRotation, setTargetRotation] = useState<{
    x: number; y: number; startX: number; startY: number; distance: number; startTime: number; duration: number
  } | null>(null)
