...
export interface LandingProductReviewCadenceProps extends React.HTMLAttributes<HTMLElement> {
  title?: string;
  description?: string;
  items: ReviewCadenceItem[];
}

export const LandingProductReviewCadence = React.forwardRef<HTMLElement, LandingProductReviewCadenceProps>(
  ({ className, title = "Make the review cadence part of the product story", description, items, ...props }, ref) => {
    return (
...
LandingProductReviewCadence.displayName = "LandingProductReviewCadence";