/**
 * RetroGrid (WebGL version — upgraded from CSS)
 * WebGL-rendered, perspective-correct infinite scrolling retro grid.
 * Uses GLSL shaders with LOD, IntersectionObserver (pauses when off-screen),
 * ResizeObserver, WebGL context lost/restored recovery, and CSS fallback.
 * Auto-detects dark mode from `.dark` class or `prefers-color-scheme`.
 *
 * Deps: none
 * Usage:
 ...
 *
 *   // Custom
 *   <RetroGrid angle={60} cellSize={80} opacity={0.7} lightLineColor="blue" darkLineColor="cyan" />
 */
"use client"
...
interface RetroGridProps extends HTMLAttributes<HTMLDivElement> {
  className?: string
  /** Rotation angle (degrees). Range 1–89. @default 65 */
  angle?: number
  /** Grid cell size (px). @default 60 */
  cellSize?: number
  /** Grid opacity 0–1. @default 0.5 */
  opacity?: number
