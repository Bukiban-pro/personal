...
- Artifacts created: runs\phase1_smoke_recheck\normalize\normalized_manifest.json, runs\phase1_smoke_recheck\normalize\normalized_annotations.json, runs\phase1_smoke_recheck\normalize\split.json, runs\phase1_smoke_recheck\normalize\class_mapping.json, runs\phase1_smoke_recheck\normalize\failure_gallery.json
- Validation performed: python collect_and_convert.py --source-manifest ... --taxonomy ... --output-dir ...
- Evidence: runs\phase1_smoke_recheck\normalize\normalized_manifest.json, runs\phase1_smoke_recheck\normalize\normalized_annotations.json, runs\phase1_smoke_recheck\normalize\split.json, runs\phase1_smoke_recheck\normalize\class_mapping.json, runs\phase1_smoke_recheck\normalize\failure_gallery.json
