...
- Artifacts created: runs\phase1_smoke_recheck2\rtdetr\benchmark_report.json, runs\phase1_smoke_recheck2\rtdetr\step_report.md
- Validation performed: python train/rtdetr_train.py --config ... --output-dir ... --mode smoke
- Evidence: runs\phase1_smoke_recheck2\rtdetr\benchmark_report.json
