...
- Artifacts created: runs\phase1_smoke\rtdetr\benchmark_report.json, runs\phase1_smoke\rtdetr\step_report.md
- Validation performed: python train/rtdetr_train.py --config ... --output-dir ... --mode smoke
- Evidence: runs\phase1_smoke\rtdetr\benchmark_report.json
