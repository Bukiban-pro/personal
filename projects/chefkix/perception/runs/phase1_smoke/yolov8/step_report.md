...
- Artifacts created: runs\phase1_smoke\yolov8\best_checkpoint.json, runs\phase1_smoke\yolov8\metrics.json, runs\phase1_smoke\yolov8\predictions.json, runs\phase1_smoke\yolov8\train_report.json, runs\phase1_smoke\yolov8\step_report.md
- Validation performed: python train/yolov8_train.py --config ... --output-dir ... --mode smoke
- Evidence: runs\phase1_smoke\yolov8\train_report.json
